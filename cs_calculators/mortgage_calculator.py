...
from cs_calculators.financial_calculator import FinancialCalculator # Absolute import
...
"""
# -Bash (Example)------------------------------------------------------------------------------------
# | python my-calc-app\cs_calculators\mortgage_calculator.py --loan 300000 --rate 0.05 --years 30   |
# ---------------------------------------------------------------------------------------------------
"""
